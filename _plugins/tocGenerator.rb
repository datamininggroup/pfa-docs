...
module Jekyll
  module TOCGenerator
    ...
    TOC_CONTAINER_HTML = '<div id="toc-container"><table class="tiktoc" id="toc"><tbody><tr><td>%1<ul>%2</ul></td></tr></tbody></table></div>'
   ...
   def toc_generate(html)
        ...
        if toc_html.length > 0
            ...
            doc.css('body').children.to_xhtml(indent:0, indent_text:" ")
        else
            return html
        end
   end
